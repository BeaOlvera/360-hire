...
const TEXTS = {
  en: {
    ...
    points: [
      ...
      '<strong>Your rights:</strong> Under GDPR (where applicable), you have the right to access, rectify, or request deletion of your data. Contact <a href="mailto:bolvera.arias8@gmail.com" style="color:#0F3D3E">bolvera.arias8@gmail.com</a>.',
    ],
    accept: 'I have read and understood the above. I consent to participate.',
    button: 'Continue',
  },
  es: {
    ...
    points: [
      ...
      '<strong>Tus derechos:</strong> Bajo el RGPD (donde aplique), tienes derecho a acceder, rectificar o eliminar tus datos. Contacto: <a href="mailto:bolvera.arias8@gmail.com" style="color:#0F3D3E">bolvera.arias8@gmail.com</a>.',
    ],
    accept: 'He leído y comprendido lo anterior. Acepto participar.',
    button: 'Continuar',
  },
} as const
